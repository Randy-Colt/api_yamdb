# Generated by Django 3.2 on 2024-06-05 17:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('moderator', 'Moder'), ('admin', 'Admin')], default='user', max_length=10, verbose_name='Роль')),
                ('confirmation_code', models.CharField(blank=True, editable=False, max_length=300, null=True, unique=True)),
